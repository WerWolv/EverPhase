package com.werwolv.game.render.shadow;
...
public class ShadowBox {
	...
	protected void update() {
		...
		Vector3f forwardVector = Maths.toVector3f(rotation.transform(FORWARD, new Vector4f()));
	...
	protected Vector3f getCenter() {
		...
		return Maths.toVector3f(invertedLight.transform(cen, new Vector4f()));
	}
	...
	private Vector4f[] calculateFrustumVertices(Matrix4f rotation, Vector3f forwardVector, Vector3f centerNear, Vector3f centerFar) {
		Vector3f upVector = Maths.toVector3f(rotation.transform(UP, new Vector4f()));
	...
	private Vector4f calculateLightSpaceFrustumCorner(Vector3f startPoint, Vector3f direction, float width) {
		...
		point4f = lightViewMatrix.transform(point4f, new Vector4f());
		return point4f;
	}
